...
# LOCAL_SRC_FILES += $LOCAL_PATH/APP/myjni.cpp
...
LOCAL_CFLAGS += -march=armv7-a -mtune=cortex-a8 -mfpu=neon -fpic -mthumb-interwork -mfloat-abi=softfp -ftree-vectorize -fomit-frame-pointer -ffast-math -funroll-loops -funsafe-math-optimizations -fsingle-precision-constant
LOCAL_CFLAGS += -O3
