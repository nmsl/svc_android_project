...
# Jargo -> add "-I$(LOCAL_PATH)/lib"
LOCAL_CFLAGS += $(common_CFLAGS) -I$(LOCAL_PATH)/lib
...
LOCAL_CFLAGS += $(common_CFLAGS) -O3

# Jargo -> add "LOCAL_LDLIBS += -lz" if for SHARED library
# LOCAL_LDLIBS += -lz

# Jargo -> build shared library
...
#########################
# Build the prebuild static library for libcurl

# include $(CLEAR_VARS)

# LOCAL_MODULE := curl
# LOCAL_SRC_FILES := $(LOCAL_PATH)/../../obj/local/$(TARGET_ARCH_ABI)/libcurl.a
